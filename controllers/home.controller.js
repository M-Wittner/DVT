myApp.controller('homeCtrl', ['$scope', '$rootScope', '$state', '$http', 'AuthService', 'AUTH_EVENTS', 'USER_ROLES', '$location', 'Flash','Session','$cookies', '$window', function ($scope, $rootScope, $state, $http, AuthService, AUTH_EVENTS, USER_ROLES, $location,
